...
sys.path.append('/mnt/d/home/projects/github/inspector-gadget/src/lib/python2.7/site-packages')
...
def get_largest_obj(url, ip, count):
...
if __name__ == "__main__":
	...
	site_size, site_obj = get_largest_obj("https://"+url, dst_ip, 100)
