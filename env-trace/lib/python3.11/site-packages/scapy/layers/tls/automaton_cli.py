...
class TLSClientAutomaton(_TLSAutomaton):
    ...
    def parse_args(self, server="127.0.0.1", dport=4433, server_name=None,
        ...
        #!!!! here !!!!
        print("in parse_args")
        self.__IG_SETUP_DONE__ = False
        self.__IG_HANDSHAKE_DONE__ = False
    ...
    def CONNECT(self):
        ...
        ### !!!! HERE !!!!
        s.setsockopt(socket.IPPROTO_TCP, socket.TCP_MAXSEG, 200)
        s.setblocking(True)
        ...
        ### !!!! HERE !!!!
        self.__IG_PORT_NUMBER__ = s.getsockname()[1]
    ...
    def HANDLED_SERVERFINISHED(self):
        ...
        # !!!! here !!!
        self.__IG_HANDSHAKE_DONE__ = True
